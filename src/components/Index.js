...
// Componente Card modificado para usar solo texto en el pie de página
  ...
  <div>
    ...
    <div className="card-container">
      ...
      <Card id="2" header="Island of Enchantment" openLabel="Puerto Rico"
        ...
        footerLink={{ text: "Discover Puerto Rico" }}
      />
      ...
      <Card id="4" header="European Charm" openLabel="Italy"
        ...
        footerLink={{ text: "Discover Italy" }}
      />
      ...
      <Card id="6" header="Nordic Adventures" openLabel="Norway"
        ...
        footerLink={{ text: "Discover Norway" }}
      />
    </div>
  </div>
);
